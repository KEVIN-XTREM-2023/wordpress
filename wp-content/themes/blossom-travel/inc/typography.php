...
function blossom_travel_fonts_url(){
    ...
    $ig_site_title_font = blossom_travel_is_google_font( $site_title_font['font-family'] );
    ...
    */
    ...
    $site_title = _x( 'on', 'Site Title Font: on or off', 'blossom-travel' );
    ...
    if ( 'off' !== $primary || 'off' !== $secondary || 'off' !== $site_title ) {
        ...
        if ( 'off' !== $site_title && $ig_site_title_font ) {
            ...
            if( ! empty( $site_title_font['variant'] ) ){
                $site_title_var = ':' . blossom_travel_check_varient( $site_title_font['font-family'], $site_title_font['variant'] );    
            }else{
                $site_title_var = '';
            }
    ...
    if( get_theme_mod( 'ed_localgoogle_fonts', false ) ) {
        $fonts_url = blossom_travel_get_webfont_url( add_query_arg( $query_args, 'https://fonts.googleapis.com/css' ) );
    }
